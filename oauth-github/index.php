...
<nav class="navbar">
  <div class="navbar-content">
    ...
    <div class="navbar-items">
      ...
      <a href="https://github.com/login/oauth/authorize?client_id=eb745473cc9cefa643ae" 
        class="bar-item button">Prijava</a>
      <a href="#najpoznatije-baze" class="bar-item button js-world-database-all">Najpoznatije baze</a>
...
<main class="content padding js-main" style="max-width:1564px">
<div class="container padding-32 search-result">
  ...
  <div class="row-padding" id="lista">
  ...
  <div class="container padding-32" id="node-rezultat"></div>
</main>
...
<script src="scripts/node-rest-service-client.js"></script>
</body>
</html>
